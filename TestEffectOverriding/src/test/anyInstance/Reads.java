...
public class Reads extends Root {
  // GOOD
  @Override
  @RegionEffects("reads any(Root):B, any(Reads):B")
  ...
  // BAD: More general than B
  @Override
  @RegionEffects("writes test.anyInstance.Root:S")
  public void writesExplicitStaticSuperRegion() {}
  
  // BAD: More unrelated to B
  @Override
  @RegionEffects("writes test.anyInstance.Root:T")
  public void writesExplicitStaticUnrelatedRegion() {}
  
  // BAD: More unrelated to B
  @Override
  @RegionEffects("writes test.anyInstance.Writes:TT")
  ...
  // BAD: More general than B
  @Override
  @RegionEffects("reads test.anyInstance.Root:S")
  public void readsExplicitStaticSuperRegion() {}
  
  // BAD: More unrelated to B
  @Override
  @RegionEffects("reads test.anyInstance.Root:T")
  public void readsExplicitStaticUnrelatedRegion() {}
  
  // BAD: More unrelated to B
  @Override
  @RegionEffects("reads test.anyInstance.Writes:TT")
