 ...
 * </ul> 
 */ 
public abstract class IRSequenceWrapper<T> implements IRSequence<T>
{
  protected final IRSequence<T> sequence;

  /** Create an IRSequence that delegates all requests to the parameter. */
  protected IRSequenceWrapper(IRSequence<T> seq) {
    sequence = seq;
  }
  ...
  public IRLocation insertElementAt(T element, InsertionPoint ip) {
