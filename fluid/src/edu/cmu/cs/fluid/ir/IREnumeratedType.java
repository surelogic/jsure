// $Header: /cvs/fluid/fluid/src/edu/cmu/cs/fluid/ir/IREnumeratedType.java,v 1.16 2006/04/05 16:46:35 chance Exp $
 ...
 */
public class IREnumeratedType extends CachedType<IREnumeratedType.Element> implements Comparator<IREnumeratedType.Element> {
   ...
   */
  private static final Map<String,IREnumeratedType> types;
  ...
  static {
    ...
    types = new HashMap<String,IREnumeratedType>();
  }
   ...
   */
  public synchronized static IREnumeratedType getIterator(final String name) {
   ...
   */
  protected synchronized static void defineIterator(
    final String name,
  ...
  public Comparator<IREnumeratedType.Element> getComparator() {
    return this;
  }
  ...
  @Override
  protected IREnumeratedType.Element createValue(final IRInput in) throws IOException {
  ...
  public IRType<IREnumeratedType.Element> readType(final IRInput in) throws IOException {
    final String type = in.readUTF();
    ...
    try {
      final IREnumeratedType enm = new IREnumeratedType(type, n, false);
      if (IREnumeratedType.typeExists(type)) {
        final IREnumeratedType existingType =
          IREnumeratedType.getIterator(type);
        if (!existingType.equals(enm)) {
        ...
        IREnumeratedType.defineIterator(type, enm);
        return enm;
      }
  ...
  public IREnumeratedType.Element fromString(String s) {
    return Element.valueOf(this, s);
  }

  public String toString(IREnumeratedType.Element e) {
    return e.toString();
  }
  ...
  public static class Element implements Comparable {
    ...
    public IREnumeratedType getType() {
      return IREnumeratedType.getIterator(type);
    }
