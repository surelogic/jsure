...
public abstract class Drop implements IDropInfo {
	 ...
	 * <p>
	 * <b>HACK WARNING:</b> This method depends upon (in its implementation)
	 * the existence of the {@link CUDrop} class. Fluid, within Eclipse, uses
	 * compilation unit level change. As Fluid becomes more incremental, i.e.,
	 * we have a working incremental parser, this part of change dependency
	 * management will have to be overhauled. I see two problems with the
	 * current implementation of this method:
	 * <ul>
	 * <li>Drop depends upon CUDrop (a subclass), a design no-no</li>
	 * <li>We are not flexible enough to allow dependencies as fine-grained as
	 * the actual program analyses can support (e.g., constructor, method, etc.)</li>
	 * </ul>
	 * 
	 * @param node
	 *            the fAST node specifying the compilation unit this drop needs
	 *            to depend upon. If this is <code>null</code> no dependency
	 *            is added.
	 */
