...
public class VersionTest {
  ...
  void test(String[] args) {
    ...
    Slot <Integer>w = VersionedSlotFactory.prototype.<Integer>predefinedSlot((Integer)null);
    Slot<Integer> x = w;
    Slot <Integer>y = w;
    Slot<Integer> z = w;
  ...
  public void testlca(
    ...
    for (int i = 0; i < n; ++i) {
      for (int j = 0; j < n; ++j) {
        ...
        // reportError("Testing latestCommonAncestor(v" + names[i] +
        //		   ",v" + names[j] + ") ...");
  ...
  public void testPrecedes(String[] names, Version[] versions) {
    int n = names.length;
    if (verbose)
  ...
  public void testGetNextInPreorder(
    String[] names,
    Version[] versions) {
    int n = names.length;
    if (verbose)
