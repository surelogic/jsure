/* $Header: /cvs/fluid/fluid/src/edu/cmu/cs/fluid/mvc/tree/NoEllipsisVerticalEllipsisPolicy.java,v 1.3 2007/07/05 18:15:17 aarong Exp $ */
 ...
 */
public final class NoEllipsisVerticalEllipsisPolicy
implements ForestVerticalEllipsisPolicy
{
  /** Prototype for the policy. */
  public static final NoEllipsisVerticalEllipsisPolicy prototype = new NoEllipsisVerticalEllipsisPolicy();

  private NoEllipsisVerticalEllipsisPolicy()
  {
    super();
  }
  ...
  @Override
  public IRNode nodeSkipped( final IRNode node, final IRNode parent, int pos, int oldPos )
  {
    return parent;
  }
