 ...
 * @version $Revision: 1.7 $ $Date: 2007/07/10 22:16:30 $
 * @since Commons Collections 3.0
 */
public class CustomizableHashedMap <K,V> extends AbstractHashMap<K, V> {
    /**
     * Map entries
     */
     ...
     */
    protected CustomizableHashedMap() {
        super();
    }
    ...
    protected CustomizableHashedMap(int initialCapacity, float loadFactor, int threshold) {
        super();
     ...
     */
    protected CustomizableHashedMap(int initialCapacity) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected CustomizableHashedMap(int initialCapacity, float loadFactor) {
        super();
     ...
     */
    protected CustomizableHashedMap(Map<? extends K, ? extends V> map) {
    ...
    protected static class HashMapIterator <K,V> extends HashIterator<K, V> implements MapIterator<K, V> {
        ...
        protected HashMapIterator(CustomizableHashedMap<K, V> parent) {
            super(parent);
        }
        ...
        public V getValue() {
            HashEntry<K, V> current = currentEntry();
            if (current == null) {
                throw new IllegalStateException(AbstractHashMap.GETVALUE_INVALID);
            }
        ...
        public V setValue(V value) {
            HashEntry<K, V> current = currentEntry();
            if (current == null) {
                throw new IllegalStateException(AbstractHashMap.SETVALUE_INVALID);
            }
    ...
    protected static class EntrySet <K,V> extends AbstractSet<Map.Entry<K, V>> {
         ...
         * The parent map
         */
        protected final CustomizableHashedMap<K, V> parent;

        protected EntrySet(CustomizableHashedMap<K, V> parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class EntrySetIterator <K,V> extends HashIterator<K, V> implements Iterator<Map.Entry<K, V>> {
        ...
        protected EntrySetIterator(CustomizableHashedMap<K, V> parent) {
            super(parent);
        }
    ...
    protected static class KeySet <K,V> extends AbstractSet<K> {
        ...
        protected KeySet(CustomizableHashedMap<K, V> parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class KeySetIterator <K,V> extends HashIterator<K, V> implements Iterator<K> {
        ...
        protected KeySetIterator(CustomizableHashedMap<K, V> parent) {
            super(parent);
        }
    ...
    protected static class Values <K,V> extends AbstractCollection<V> {
        ...
        protected Values(CustomizableHashedMap<K, V> parent) {
            super();
            this.parent = parent;
        }
    ...
    protected static class ValuesIterator <K,V> extends HashIterator<K, V> implements Iterator<V> {
        ...
        protected ValuesIterator(CustomizableHashedMap<K, V> parent) {
            super(parent);
        }
    ...
    protected static abstract class HashIterator <K,V> {
        ...
        protected HashIterator(CustomizableHashedMap<K, V> parent) {
            super();
            this.parent = parent;
    ...
    protected Object clone() {
        try {
            CustomizableHashedMap cloned = (CustomizableHashedMap) super.clone();
