...
/**
 * Originally AbstractHashedMap from Commons Collections (generic), but
 * modified to directly use the hashCode() of the key.
 * - No caching of the hash in the map entry
 * 
...
public class CustomizableHashCodeMap <K,V> extends AbstractHashMap<K, V> {
    ...
    protected CustomizableHashCodeMap(int initialCapacity, float loadFactor, int threshold) {
        super();
    ...
    public V get(Object key) {
    	//gets++;
        int hashCode = key == null ? NULL_HASH : key.hashCode();
        ...
        // case 1
        if (entry.key.hashCode() == hashCode && isEqualKey(key, entry.key)) {
    ...
    */
	public static void printStats() {
       ...
       System.out.println("avg = "+iters/(double)gets);
       */
	}
    ...
    public boolean containsKey(Object key) {
        ...
        while (entry != null) {
            if (entry.key.hashCode() == hashCode && isEqualKey(key, entry.getKey())) {
                return true;
            }
            entry = entry.next;
        }
     ...
     */
    /*
    protected final int hash(Object key) {
      return key.hashCode();
    ...
    */
              ...
              if (entry != null) {
                  ...
                  do {
                    ...
                    if (isValidEntry(entry)) {
                      int index = hashIndex(entry.key.hashCode(), newCapacity);
    ...
    protected Object clone() {
        try {
            CustomizableHashCodeMap cloned = (CustomizableHashCodeMap) super.clone();
