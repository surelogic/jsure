...
public class CopiedHashMap extends AbstractMap implements Map, Cloneable,
    Serializable
{
    /**
     ...
     */
    transient protected Entry[] table;
     ...
     */
    public CopiedHashMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public CopiedHashMap(int initialCapacity) {
    ...
    @Override
    public Object clone() {
			CopiedHashMap result = null;
	try { 
	    result = (CopiedHashMap)super.clone();
		  result.keySet = null;
		  result.values = null;
    ...
    static protected class Entry implements Map.Entry {
        ...
        public final void setNext(Entry newNext) {
          next = newNext;
        }
         ...
         * in the HashMap.
         */
        void recordAccess(CopiedHashMap m) {
        }
         ...
         */
        void recordRemoval(CopiedHashMap m) {
        }
    }
    ...
    void addEntry(Entry e, int bucketIndex) {
	  ...
	  void createEntry(Entry e, int bucketIndex) {
			e.next = table[bucketIndex];
		  table[bucketIndex] = e;
		  size++;
	  }
    ...
    private abstract class HashIterator extends AbstractIterator {
        ...
        public void remove() {
            ...
            current = null;
					CopiedHashMap.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
