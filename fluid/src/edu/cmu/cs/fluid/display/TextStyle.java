...
{
  private static Map<String,Font> fonts = new Hashtable<String,Font>( 20 );
  ...
  // Inner class
  public static class AttributeNotSetException
  extends Exception
  {
   ...
   * flag is <tt>false</TT>.
   */
  public Iterator<Color> getBackground() throws AttributeNotSetException
  {
    if( backgroundSet )
   ...
   * flag is <tt>false</TT>.
   */
  public Iterator<Color> getSecondaryBackground() throws AttributeNotSetException
  {
    if( backgroundSet )
   ...
   * ordered list of secondary colors.
   */
  public Iterator<Color> getBackground( final TextStyle defaultStyle )
  {
    if( backgroundSet ) {
      return new BackgroundIterator( primaryBack, secondaryBack );
    } else {
   ...
   * @param defaultStyle The default style to use.
   */
  public Iterator<Color> getSecondaryBackground( final TextStyle defaultStyle )
  {
    if( backgroundSet )
      return new BackgroundIterator( secondaryBack );
    else
    ...
    if( x != null && x.getClass().equals( this.getClass() ) )
    {
      ...
      if( eq )
      {
        ...
        if( backgroundSet ) {
          ...
          if( eq ) {
            final Iterator<Color> it1 = new BackgroundIterator( secondaryBack );
            final Iterator<Color> it2 = new BackgroundIterator( y.secondaryBack );
            while( it1.hasNext() && it2.hasNext() )
            {
              final Color c1 = it1.next();
              final Color c2 = it2.next();
              eq &= c1.equals( c2 );
            }
          }
        }
  ...
  public int hashCode()
  {
    ...
    if( backgroundSet )
    {
      final Iterator<Color> iter = new BackgroundIterator( primaryBack, secondaryBack );
      while( iter.hasNext() ) {
  ...
  private static class BackgroundIterator
  extends AbstractRemovelessIterator<Color>
  {
