/* $Header: /cvs/fluid/fluid/src/edu/cmu/cs/fluid/java/JavaUnparseStyle.java,v 1.14 2005/05/23 18:28:40 chance Exp $ */
...
public class JavaUnparseStyle {
  ...
  /* <angle> */
  private static Token defaultANGLE = IndepBP.JUXTBP;
  private Token TKANGLE = defaultANGLE;
  public Token getANGLE() { return TKANGLE; }
  public void setANGLE(Token tk) { TKANGLE = tk; }

  /* </angle> */
  private static Token defaultENDANGLE = IndepBP.JUXTBP;
  private Token TKENDANGLE = defaultENDANGLE;
  public Token getENDANGLE() { return TKENDANGLE; }
  public void setENDANGLE(Token tk) { TKENDANGLE = tk; }
