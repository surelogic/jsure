...
import edu.cmu.cs.fluid.sea.AbstractSeaConsistencyProofHook;
import edu.cmu.cs.fluid.sea.PromiseDrop;
import edu.cmu.cs.fluid.sea.ResultDrop;
import edu.cmu.cs.fluid.sea.Sea;
import edu.cmu.cs.fluid.sea.drops.promises.VouchPromiseDrop;
      ...
      for (final ResultDrop rd : sea.getDropsOfType(ResultDrop.class)) {
        if (!rd.isConsistent()) {
          ...
          if (vouch != null) {
            ...
            vouch.addSupportingInformation("(analysis result vouched for) " + rd.getMessage(), rd.getNode());
          }
        }
      }
    }
