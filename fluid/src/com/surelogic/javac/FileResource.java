...
public class FileResource implements ICodeFile {
	...
	public FileResource(Projects projects, File classFile, String qname, String proj) {
		this(computePackage(qname), classFile.getName(), /*convertToURI(projects, classFile.toURI())*/
			 new Pair<URI,String>(classFile.toURI(), null), proj); // TODO fix null
	}
	
	public FileResource(Projects projects, JavaFileObject sourceFile, String pkg, String proj) {
		this(pkg, sourceFile.getName().substring(0, sourceFile.getName().length()-5), 
