...
public final class ThreadSafeProcessor extends TypeImplementationProcessor {
  private static final int TS_THREAD_SAFE_SUPERTYPE = 400;
  private static final int TS_TRIVIALLY_THREADSAFE = 401;
  private static final int TS_VOUCHED_THREADSAFE = 402;
  private static final int TS_VOUCHED_THREADSAFE_WITH_REASON = 403;
  private static final int TS_FIELD_IS_THREADSAFE = 404;
  private static final int TS_FIELD_IS_NOT_THREADSAFE = 405;
  private static final int TS_FIELD_DECL_IS_SAFE = 406;
  private static final int TS_FIELD_DECL_IS_NOT_SAFE = 407;
  private static final int TS_FIELD_IS_FINAL = 408;
  private static final int TS_FIELD_IS_NOT_FINAL = 409;
  private static final int TS_FIELD_IS_VOLATILE = 410;
  private static final int TS_FIELD_IS_NOT_VOLATILE = 411;
  private static final int TS_FIELD_IS_PROTECTED = 412;
  private static final int TS_FIELD_IS_NOT_PROTECTED = 413;
  private static final int TS_OBJECT_IS_PROTECTED = 414;
  private static final int TS_OBJECT_IS_NOT_PROTECTED = 415;
  private static final int TS_TYPE_IS_PRIMITIVE = 416;
  private static final int TS_TYPE_IS_NOT_PRIMITIVE = 417;
  private static final int TS_TYPE_IS_THREADSAFE = 418;
  private static final int TS_TYPE_IS_NOT_THREADSAFE = 419;
  private static final int TS_THREADSAFE_IMPL = 420;
  private static final int TS_OBJECT_IS_CONTAINED = 421;
  private static final int TS_OBJECT_IS_NOT_CONTAINED = 422;
  private static final int TS_TYPE_IS_CONTAINABLE = 423;
  private static final int TS_TYPE_IS_NOT_CONTAINABLE = 424;
  private static final int TS_FIELD_IS_UNIQUE = 425;
  private static final int TS_FIELD_IS_NOT_UNIQUE = 426;
  private static final int TS_DEST_REGION_PROTECTED = 427;
  private static final int TS_DEST_REGION_UNPROTECTED = 428;
  ...
  protected void processSuperType(final IRNode name, final IRNode tdecl) {
    ...
    if (pDrop != null) {
      final ResultDrop result = builder.createRootResult(
          true, name, TS_THREAD_SAFE_SUPERTYPE, JavaNames.getQualifiedTypeName(tdecl));
  ...
  protected void postProcess() {
    if (!hasFields) {
      builder.createRootResult(true, typeBody, TS_TRIVIALLY_THREADSAFE);
    }
  }
  ...
  protected void processVariableDeclarator(final IRNode fieldDecl,
    ...
    assureFieldIsThreadSafe(fieldDecl, varDecl);
...
//            ? builder.createRootResult(true, varDecl, TS_VOUCHED_THREADSAFE, id)
//            : builder.createRootResult(true, varDecl, TS_VOUCHED_THREADSAFE_WITH_REASON, id, reason);
...
//          varDecl, TS_FIELD_IS_THREADSAFE, TS_FIELD_IS_NOT_THREADSAFE, id);
//      
//      /*
...
//            true, part1Folder, varDecl, TS_FIELD_IS_PROTECTED, fieldLock.name);
//        result.addTrusted(fieldLock.lockDecl);
//      } else {
//        ResultsBuilder.createResult(false, part1Folder, varDecl, TS_FIELD_IS_NOT_PROTECTED);
//      }
//      
//      /*
...
//          folder, fieldTypeNode, TS_OBJECT_IS_PROTECTED, TS_OBJECT_IS_NOT_PROTECTED);
//      
...
//          TS_TYPE_IS_PRIMITIVE, TS_TYPE_IS_NOT_PRIMITIVE, type.toSourceText());
//
...
//          TS_TYPE_IS_THREADSAFE, TS_TYPE_IS_NOT_THREADSAFE, type.toSourceText());
...
//              final ResultDrop result =
//                  ResultsBuilder.createResult(true, part2folder, initExpr, TS_THREADSAFE_IMPL);
...
//          part2folder, fieldDecl, TS_OBJECT_IS_CONTAINED, TS_OBJECT_IS_NOT_CONTAINED);
...
//          TS_TYPE_IS_CONTAINABLE, TS_TYPE_IS_NOT_CONTAINABLE, type.toSourceText());
...
//            ResultsBuilder.createResult(false, containableFolder, fieldDecl, TS_FIELD_IS_NOT_UNIQUE);
//        uResult.addProposal(new ProposedPromiseDrop(
//            "Unique", null, varDecl, varDecl,  Origin.MODEL));
//      } else {
//        final ResultDrop uResult =
//            ResultsBuilder.createResult(true, containableFolder, fieldDecl, TS_FIELD_IS_UNIQUE);
...
//                true, containableFolder, varDecl, TS_DEST_REGION_PROTECTED,
...
//                TS_DEST_REGION_UNPROTECTED, destRegion.getName());
//          }
//        }
//      }
//
...
//    }
  ...
  private void assureFieldIsThreadSafe(
