...
/**
 * Replace one variable (often a pseudo) while adding the new variables.
 * @author boyland
 */
public class Replace implements Apply {
	...
	public Replace(final IMayAlias ma, final IRNode d, 
  ...
  public ImmutableHashOrderSet<Object> apply(
		...
		if (other.contains(var)) {
			...
			return other.removeElement(var).union(additional);
		}
		return other;
	}
