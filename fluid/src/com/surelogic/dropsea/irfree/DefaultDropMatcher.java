...
public class DefaultDropMatcher extends DropMatcher {
  ...
  private boolean matchHashed(IDrop n, IDrop o) {
    boolean result = matchBasics(n, o);
    long nTreeHash = n.getDiffInfoAsLong(IDiffInfo.FAST_TREE_HASH, -1);
    long oTreeHash = o.getDiffInfoAsLong(IDiffInfo.FAST_TREE_HASH, -1);
    result &= nTreeHash == oTreeHash;
    long nContextHash = n.getDiffInfoAsLong(IDiffInfo.FAST_CONTEXT_HASH, -1);
    long oContextHash = o.getDiffInfoAsLong(IDiffInfo.FAST_CONTEXT_HASH, -1);
    result &= nContextHash == oContextHash;
    return result;
  }

  private boolean matchResults(IDrop n, IDrop o) {
    boolean result = n instanceof IResultDrop;
    long nTreeHash = n.getDiffInfoAsLong(IDiffInfo.FAST_TREE_HASH, -1);
    long oTreeHash = o.getDiffInfoAsLong(IDiffInfo.FAST_TREE_HASH, -1);
    result &= nTreeHash == oTreeHash;
    return result;
