...
public interface IJavaElement {
	...
	/**
	 * Sets the parent of this in the XML tree. An exception will be thrown if
	 * the parent is already set.
	 * 
	 * @param p
	 *            the parent of this.
	...
	/**
	 * Gets the parent of this in the XML tree. This method returns
	 * <tt>null</tt> if this is the root.
	 * 
	...
	/**
	 * Gets the image key from {@link CommonImages} for this. Suitable for UI
	 * use.
	 * 
	 ...
	 * 
	 * @return <tt>true</tt> if changed from the files on disk, <tt>false</tt>
	 *         if unchanged.
	 */
	boolean isDirty();
	 ...
	 * wrong. Is not a complete check, JSure may find this to be bad even if
	 * this call does not.
	 * 
