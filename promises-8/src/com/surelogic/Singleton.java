 ...
 * (Second Edition)</i> (Addison-Wesley 2008) Item 3.
 * <p>
 ...
 * is multi-thread safe. Note that this does not mean that the singleton's state
 * is thread safe&mdash;it may be or it may not be&mdash;just that access to the
