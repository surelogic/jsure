 ...
 * objective.
 * <p>
 * Utility classes may be, but are not required to be, immutable, in which case
 * the {@link Immutable} annotation should be added to the class (for example,
 * if the utility class declares no fields). In general, a utility class may
 * have mutable state.
 * <p>
 ...
 * <h3>Examples:</h3>
 * 
 * The internationalization class below is a utility.
 * 
 * <pre>
 * &#064;Utility
