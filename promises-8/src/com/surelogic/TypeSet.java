...
/**
 * Declares a named set of types to be used in {@link AllowsReferencesFrom},
 * {@link MayReferTo} and {@link Layer} annotations. A type set is a global
 * entity, and may be referred to by other annotations. Its name is qualified by
 * the name of the package that it annotates. If the reference is within the
 * same package, the name does not need to be qualified.
 * <p>
