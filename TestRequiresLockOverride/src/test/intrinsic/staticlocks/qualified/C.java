package test.intrinsic.staticlocks.qualified;
...
public class C {
	...
	@RequiresLock("test.intrinsic.staticlocks.qualified.C:L, test.intrinsic.staticlocks.qualified.C:M")
	public void m1(final C a, final C b, final C c) {}
	
	@RequiresLock("test.intrinsic.staticlocks.qualified.C:L")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.C:L, test.intrinsic.staticlocks.qualified.C:M, test.intrinsic.staticlocks.qualified.C:N")
	public void m1(final C a, final C b, final C c) {}
	...
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.C:M")
	public void m4(final C a) {}		
}
...
class Bad2 extends C {
	...
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.C:N")
	public void m1(final C a, final C b, final C c) {}
}
...
class XGood2 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.X:L")
	public void m(final X a, final X b) {}
}
...
class XGood3 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.XGood3:L")
	public void m(final X a, final X b) {}
}
...
class XBad7 extends X {
	// Good: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.X:M")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.XBad8:M")
	public void m(final X a, final X b) {}
}
...
class XBad15 extends X {
	// GOOD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.X:LL.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	// GOOD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.XBad16:LL.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad23 extends X {
	// GOOD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.X:LL.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad24 extends X {
	// GOOD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.staticlocks.qualified.XBad24:LL.writeLock()")
	public void m(final X a, final X b) {
	}
}
