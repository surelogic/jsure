package test.intrinsic.receiver.qualified;
...
public class C {
	...
	@RequiresLock("C.this:L, C.this:M")
	public void m1(final C a, final C b, final C c) {}
	
	@RequiresLock("C.this:L")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("Bad1.this:L, Bad1.this:M, Bad1.this:N")
	public void m1(final C a, final C b, final C c) {}
	
	// BAD: Cannot add lock to explicit empty
	@Override
	@RequiresLock("Bad1.this:L")
	public void m3(final C a) {}
	
	// BAD: Cannot add lock to implicit empty
	@Override
	@RequiresLock("Bad1.this:M")
	public void m4(final C a) {}		
}
...
class XBad9 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.X:N")
	public void m(final X a, final X b) {}
}
...
class XBad10 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.XBad10:N")
	public void m(final X a, final X b) {}
}
...
class XBad17 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.X:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad18 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.XBad18:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad25 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.X:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad26 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.receiver.qualified.XBad26:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
