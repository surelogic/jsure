package test.read.receiver.explicit;
...
public class C {
	...
	@RequiresLock("this:L.readLock(), this:M.readLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("this:L.readLock(), this:M.readLock(), this:N.readLock()")
	public void m1(final C a, final C b, final C c) {}
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.explicit.X:NN")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.explicit.XBad8:NN")
	public void m(final X a, final X b) {}
}
...
class XBad12 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.explicit.X:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad13 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.explicit.XBad13:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad20 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.explicit.X:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad21 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.explicit.XBad21:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
