package test.read.receiver.implicit;
...
public class C {
	...
	@RequiresLock("L.readLock(), M.readLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("L.readLock(), M.readLock(), N.readLock()")
	public void m1(final C a, final C b, final C c) {}
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.implicit.X:NN")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.implicit.XBad8:NN")
	public void m(final X a, final X b) {}
}
...
class XBad12 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.implicit.X:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad13 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.implicit.XBad13:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad20 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.implicit.X:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad21 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.implicit.XBad21:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
