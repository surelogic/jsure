package test.write.staticlocks.simple;
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.X:LL")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.XBad8:LL")
	public void m(final X a, final X b) {}
}
...
class XGood2 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.X:L.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XGood3 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.XGood3:L.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad15 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.X:M.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.XBad16:M.readLock()")
	public void m(final X a, final X b) {
	}
}
// ==== Write Locks ====
...
class XGood5 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.X:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XGood6 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.XGood6:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad23 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.X:M.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad24 extends X {
	...
	@Override
	@RequiresLock("test.write.staticlocks.simple.XBad24:M.writeLock()")
	public void m(final X a, final X b) {
	}
}
