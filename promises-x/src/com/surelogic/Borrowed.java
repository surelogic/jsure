 ...
 * passed to the parameter or receiver of the method to which this annotation is
 * applied does not receive any new aliases due to reads from the annotated
 * parameter or receiver during execution of the method or constructor. That is,
 ...
 * 
 * <p>
 * It is a modeling error to annotate <tt>&#64;Borrowed("this")</tt> on a
 * {@code static} method. For example, the declaration
 * 
 * <pre>
 ...
 * </pre>
 * 
 * Annotating a parameter as &#064;Borrowed only specifies that the method will
 * not alias the reference in the annotated parameter
 * <em>via that parameter</em>. If the method has access to that reference via
 * another non-borrowed parameter, aliases may be created through the other
 * parameter. Consider
 * 
 * <pre>
 * public class Example {
 ...
 * 
 * <p>
 * Let's consider the calls to <code>method()</code> from <code>run()</code>:
 * <ul>
 ...
 * <li>The third call passes the value of the <code>&#064;Unique</code> field
 * <code>u</code> to both parameters. This case is troubling because
 ...
 * assurance because simply passing the value of <code>u</code> to two arguments
 * of the same method creates aliases
 * </ul>
 *
 * @see Unique
 */
