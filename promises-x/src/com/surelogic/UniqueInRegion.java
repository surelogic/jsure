 ...
 * Therefore, the two annotations below on the {@code friends} field are
 * equivalent.
 * 
 * <pre>
 * &#064;Unique
 ...
 * </pre>
 * 
 * In addition, a more complex syntax is allowed where regions of the object
 * referenced by the annotated field are explicitly mapped to regions of the
 * object that contains the annotated field. Using this syntax the annotation
 * below is equivalent to the two previous examples.
 * 
 * <pre>
 ...
 * </pre>
 * 
 * The more complex syntax is necessary when only a portion of a referenced
 * object is to be aggregated is more complex. Consider the highly contrived
 * example below.
 * 
 * <pre>
 * &#064;Regions({
