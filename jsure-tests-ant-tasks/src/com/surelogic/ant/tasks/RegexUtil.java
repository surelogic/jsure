...
public class RegexUtil {
	...
	private static interface SelectNode {
		 ...
		 */
		public String select(Vector<Object> groups);
	}
	 ...
	 */
	private static Vector<Object> parseSelectString(String input) {
	 ...
	 */
	public static String select(String select, Vector<Object> groups) {
		Vector<Object> nodes = parseSelectString(select);
