...
public final class SSLOutputWriter{
     ...
     * @param socketChannel  <code>SocketChannel</code> to flush
    ...
    public static long flushChannel(SocketChannel socketChannel, ByteBuffer bb)
        ...
        return flushChannel(socketChannel,bb,outputBB,sslEngine);
    }
     ...
     * Encrypt the response and flush it using <code>OutputWriter</code>
     * @param socketChannel  <code>SocketChannel</code> to flush 
     * @param bb  input <code>ByteBuffer</code>
     * @param outputBB  output <code>ByteBuffer</code>
