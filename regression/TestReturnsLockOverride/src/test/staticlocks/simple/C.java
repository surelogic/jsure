package test.staticlocks.simple;
...
class Good3b extends C { // *
  ...
  @Override
  @ReturnsLock("test.staticlocks.simple.C:L")
...
class Good3C extends C { // *
  ...
  @Override
  @ReturnsLock("test.staticlocks.simple.Good3C:L")
  public Object get(final C x, final C y) {
    return C.class;
  }
}
...
class Bad2b extends C {
  ...
  @Override
  @ReturnsLock("test.staticlocks.simple.C:M")
  public Object get(final C x, final C y) {
    return lock;
  }
}
class Bad2c extends C {
  // BAD: Wrong lock: qualified
  @Override
  @ReturnsLock("test.staticlocks.simple.Bad2c:M")
  public Object get(final C x, final C y) {
    return lock;
  }
}
