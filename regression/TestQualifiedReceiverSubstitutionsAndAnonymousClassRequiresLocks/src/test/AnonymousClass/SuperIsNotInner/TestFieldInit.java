...
public class TestFieldInit {
  ...
  final Super s1 = new Super() { 
    private int g = 10;
    { TestFieldInit.this.accessT(); } // Lock for T is NOT held
  };
  ...
  public class Middle1 {
    ...
    final Super s3 = new Super() { 
      private int g = 10;
      { Middle1.this.accessM1(); } // No way to hold m1
      { TestFieldInit.this.accessT(); }
    };      
    ...
    public class Middle2 {
      ...
      final Super s5 = new Super() { 
        ...
        { Middle2.this.accessM2(); } // No way to hold m2
        { TestFieldInit.this.accessT(); }
      };        
