package test.intrinsic.formals;
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.formals.X:N")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.intrinsic.formals.XBad8:N")
	public void m(final X a, final X b) {}
}
...
class XBad9 extends X {
	// BAD: formal identical, read lock
	@Override
...
class XBad14 extends X {
	// BAD: 0th-qualified receiver
	@Override
	@RequiresLock("XBad14.this:LL.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.formals.X:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad17 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.formals.XBad17:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad25 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.intrinsic.formals.X:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad26 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.intrinsic.formals.XBad17:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
