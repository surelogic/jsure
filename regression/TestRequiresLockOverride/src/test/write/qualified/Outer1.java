...
public class Outer1 {
  ...
  class Bad2c extends C {
    ...
    @Override
    @RequiresLock("Bad2c.this:L.writeLock()")
    public void get(final Outer1 a, final Outer1 b) {
    }
  }
  ...
  class Bad3 extends C {
    // BAD: Wrong lock
    @Override
    @RequiresLock("Outer1.this:M.writeLock()")
    public void get(final Outer1 a, final Outer1 b) {
    }
  }
  ...
  class Bad5 extends C {
    ...
    @Override
    @RequiresLock("test.intrinsic.qualified.Outer1:N.writeLock()")
    public void get(final Outer1 a, final Outer1 b) {
    }
  }
  ...
  public class Outer2 {
    ...
    class Bad6 extends C {
      ...
      @Override
      @RequiresLock("Outer2.this:L.writeLock()")
      public void get(final Outer1 a, final Outer1 b) {
      }
    }
  }
