...
public class C {
	...
	@RequiresLock("a:L.writeLock(), b:M.writeLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("a:L.writeLock(), b:M.writeLock(), c:L.writeLock()")
	public void m1(final C a, final C b, final C c) {}
...
class Good2b extends C {
	// GOOD: Can remove requirements;  TO READ LOCK
	@Override
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.write.formals.X:N")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.write.formals.XBad8:N")
	public void m(final X a, final X b) {}
}
...
class XBad14 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.formals.X:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad15 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.formals.XBad15:NN.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XGood3 extends X {
	// GOOD: formal identical, write lock
	@Override
	@RequiresLock("a:L.writeLock()")
	public void m(final X a, final X b) {
	}
...
class XGood4 extends X {
	// GOOD: formal renamed, write lock
	@Override
...
class XBad21 extends X {
	// BAD: 0th-qualified receiver
	@Override
	@RequiresLock("XBad21.this:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad23 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.formals.X:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad24 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.formals.XBad24:NN.writeLock()")
	public void m(final X a, final X b) {
	}
}
