package test.write.receiver.explicit;
...
public class C {
	...
	@RequiresLock("this:L.writeLock(), this:M.writeLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("this:L.writeLock(), this:M.writeLock(), this:N.writeLock()")
	public void m1(final C a, final C b, final C c) {}
...
class XBad12 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.receiver.explicit.X:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad13 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.receiver.explicit.XBad13:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad17 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.receiver.explicit.X:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad18 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.receiver.explicit.XBad18:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
