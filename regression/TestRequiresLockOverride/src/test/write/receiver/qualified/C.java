package test.write.receiver.qualified;
...
public class C {
	...
	@RequiresLock("C.this:L.writeLock(), C.this:M.writeLock()")
	public void m1(final C a, final C b, final C c) {}
	
	@RequiresLock("C.this:L.writeLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("Bad1.this:L.writeLock(), Bad1.this:M.writeLock(), Bad1.this:N.writeLock()")
	public void m1(final C a, final C b, final C c) {}
	
	// BAD: Cannot add lock to explicit empty
	@Override
	@RequiresLock("Bad1.this:L.writeLock()")
	public void m3(final C a) {}
	
	// BAD: Cannot add lock to implicit empty
	@Override
	@RequiresLock("Bad1.this:M.writeLock()")
	public void m4(final C a) {}		
}
...
class Good2a extends C {
	...
	@Override
	@RequiresLock("Good2a.this:L.writeLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Good2b extends C {
	// GOOD: Can remove requirements;
	@Override
	@RequiresLock("Good2b.this:L.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Good3a extends C {
	// GOOD: Can remove requirements
	@Override
	@RequiresLock("Good3a.this:M.writeLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Good3b extends C {
	// GOOD: Can remove requirements
	@Override
	@RequiresLock("Good3b.this:M.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Bad2 extends C {
	...
	@Override
	@RequiresLock("Bad2.this:N.writeLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class X {
	...
	@RequiresLock("X.this:L.writeLock()")
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.write.receiver.qualified.X:NN")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.write.receiver.qualified.XBad8:NN")
	public void m(final X a, final X b) {}
}
...
class XBad12 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.receiver.qualified.X:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad13 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.receiver.qualified.XBad13:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad17 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.write.receiver.qualified.X:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad18 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.write.receiver.qualified.XBad18:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
