package test.read.receiver.qualified;
...
public class C {
	...
	@RequiresLock("C.this:L.readLock(), C.this:M.readLock()")
	public void m1(final C a, final C b, final C c) {}
	
	@RequiresLock("C.this:L.readLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("Bad1.this:L.readLock(), Bad1.this:M.readLock(), Bad1.this:N.readLock()")
	public void m1(final C a, final C b, final C c) {}
	
	// BAD: Cannot add lock to explicit empty
	@Override
	@RequiresLock("Bad1.this:L.readLock()")
	public void m3(final C a) {}
	
	// BAD: Cannot add lock to implicit empty
	@Override
	@RequiresLock("Bad1.this:M.readLock()")
	public void m4(final C a) {}		
}
...
class Good2 extends C {
	...
	@Override
	@RequiresLock("Good2.this:L.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Good3 extends C {
	// GOOD: Can remove requirements
	@Override
	@RequiresLock("Good3.this:M.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class Bad2 extends C {
	...
	@Override
	@RequiresLock("Bad2.this:N.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class X {
	...
	@RequiresLock("X.this:L.readLock()")
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.qualified.X:NN")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.read.receiver.qualified.XBad8:NN")
	public void m(final X a, final X b) {}
}
...
class XBad12 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.qualified.X:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad13 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.qualified.XBad13:N.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	// BAD: implicit receiver, cannot increase requirements
	@Override
...
class XBad17 extends X {
	// BAD: explicit receiver,  cannot increase requirements
	@Override
...
class XBad18 extends X {
	// BAD: 0th-qualified receiver,  cannot increase requirements
	@Override
	@RequiresLock("XBad18.this:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad20 extends X {
	// BAD: static lock -- explicit
	@Override
	@RequiresLock("test.read.receiver.qualified.X:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad21 extends X {
	// BAD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.receiver.qualified.XBad21:N.writeLock()")
	public void m(final X a, final X b) {
	}
}
