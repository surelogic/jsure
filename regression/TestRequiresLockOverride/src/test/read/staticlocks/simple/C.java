package test.read.staticlocks.simple;
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.X:LL")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.XBad8:LL")
	public void m(final X a, final X b) {}
}
...
class XGood2 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.X:L.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XGood3 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.XGood3:L.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad15 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.X:M.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.simple.XBad16:M.readLock()")
	public void m(final X a, final X b) {
	}
}
// ==== Write Locks ====
...
class XBad23 extends X {
	// GOOD: static lock -- explicit
	@Override
	@RequiresLock("test.read.staticlocks.simple.X:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad24 extends X {
	// GOOD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.staticlocks.simple.XBad24:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
