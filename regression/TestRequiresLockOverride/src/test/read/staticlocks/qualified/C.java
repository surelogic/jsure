package test.read.staticlocks.qualified;
...
public class C {
	...
	@RequiresLock("test.read.staticlocks.qualified.C:L.readLock(), test.read.staticlocks.qualified.C:M.readLock()")
	public void m1(final C a, final C b, final C c) {}
	
	@RequiresLock("test.read.staticlocks.qualified.C:L.readLock()")
...
class Bad1 extends C {
	// BAD: Cannot add lock
	@Override
	@RequiresLock("test.read.staticlocks.qualified.C:L.readLock(), test.read.staticlocks.qualified.C:M.readLock(), test.read.staticlocks.qualified.C:N.readLock()")
	public void m1(final C a, final C b, final C c) {}
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.C:M.readLock()")
	public void m4(final C a) {}		
}
...
class Bad2 extends C {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.C:N.readLock()")
	public void m1(final C a, final C b, final C c) {}
}
...
class X {
	...
	@RequiresLock("test.read.staticlocks.qualified.X:L.readLock()")
...
class XBad7 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.X:LL")
	public void m(final X a, final X b) {}
}
...
class XBad8 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.XBad8:LL")
	public void m(final X a, final X b) {}
}
...
class XGood3 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.XGood3:L.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad15 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.X:M.readLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad16 extends X {
	...
	@Override
	@RequiresLock("test.read.staticlocks.qualified.XBad16:M.readLock()")
	public void m(final X a, final X b) {
	}
}
// ==== Write Locks ====
...
class XBad23 extends X {
	// GOOD: static lock -- explicit
	@Override
	@RequiresLock("test.read.staticlocks.qualified.X:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
...
class XBad24 extends X {
	// GOOD: static lock -- explicit 2
	@Override
	@RequiresLock("test.read.staticlocks.qualified.XBad24:L.writeLock()")
	public void m(final X a, final X b) {
	}
}
