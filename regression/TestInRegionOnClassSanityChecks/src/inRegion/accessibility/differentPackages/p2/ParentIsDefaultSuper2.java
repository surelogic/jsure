...
import inRegion.accessibility.differentPackages.p1.ParentIsDefaultSuper;
...
public class ParentIsDefaultSuper2 extends ParentIsDefaultSuper {
  // Local instance
  ...
  private int Private10; /* is UNASSOCIATED: Parent region is not accessible */    
  private int Private20; /* is UNASSOCIATED: Parent region is not accessible */    
  private int Private30; /* is CONSISTENT */    
  private int Private40; /* is CONSISTENT */    

  int Default10; /* is UNASSOCIATED: Parent region is not accessible */    
  int Default20; /* is UNASSOCIATED: Parent region is not accessible */    
  int Default30; /* is CONSISTENT */    
  int Default40; /* is CONSISTENT */    

  protected int Protected10; /* is UNASSOCIATED: Parent region is not accessible */    
  protected int Protected20; /* is UNASSOCIATED: Parent region is not accessible */    
  protected int Protected30; /* is CONSISTENT */    
  protected int Protected40; /* is CONSISTENT */    

  public int Public10; /* is UNASSOCIATED: Parent region is not accessible */    
  public int Public20; /* is UNASSOCIATED: Parent region is not accessible */    
  ...
  private static int Private1000; /* is UNASSOCIATED: Parent region is not accessible */    
  private static int Private2000; /* is UNASSOCIATED: Parent region is not accessible */    
  private static int Private3000; /* is CONSISTENT */    
  private static int Private4000; /* is CONSISTENT */    

  static int Default1000; /* is UNASSOCIATED: Parent region is not accessible */    
  static int Default2000; /* is UNASSOCIATED: Parent region is not accessible */    
  static int Default3000; /* is CONSISTENT */    
  static int Default4000; /* is CONSISTENT */    

  protected static int Protected1000; /* is UNASSOCIATED: Parent region is not accessible */    
  protected static int Protected2000; /* is UNASSOCIATED: Parent region is not accessible */    
  protected static int Protected3000; /* is CONSISTENT */    
  protected static int Protected4000; /* is CONSISTENT */    

  public static int Public1000; /* is UNASSOCIATED: Parent region is not accessible */    
  public static int Public2000; /* is UNASSOCIATED: Parent region is not accessible */    
