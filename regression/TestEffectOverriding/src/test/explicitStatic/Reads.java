...
public class Reads extends Root {
  ...
  // BAD: S is more general than T
  @Override
  @RegionEffects("reads test.explicitStatic.Root:S")
  ...
  // GOOD: U is more specific than T
  @Override
  @RegionEffects("reads test.explicitStatic.Root:U")
  public void writesExplicitStaticSubRegion() {}

  // GOOD: V is more specific than T
  @Override
  @RegionEffects("reads test.explicitStatic.Reads:V")
  public void writesExplicitStaticNewSubRegion() {}

  // BAD
  @Override
  @RegionEffects("reads test.explicitStatic.Root:O")
  public void writesExplicitStaticUnrelatedRegion() {}
  
  // BAD
  @Override
  @RegionEffects("reads test.explicitStatic.Reads:P")
