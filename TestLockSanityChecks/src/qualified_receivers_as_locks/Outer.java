...
public class Outer {
  ...
  @RegionLocks({
    ...
    @RegionLock("L is qualified_receivers_as_locks.Outer.this protects f" /* is UNASSOCIATED */),
    // Rejected with warning
    @RegionLock("L2 is qualified_receivers_as_locks.Outer.this.field protects g" /* is UNASSOCIATED */)
  })
  @PolicyLocks({
    // Rejected with warning
    @PolicyLock("P is qualified_receivers_as_locks.Outer.this" /* is UNASSOCIATED */),
    // Rejected with warning
    @PolicyLock("P2 is qualified_receivers_as_locks.Outer.this.field" /* is UNASSOCIATED */)
  })
  private class Inner {
    private int f;
    private int g;
