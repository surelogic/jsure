		...
		return new SLUIJob() {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				if (majorJavaSourceVersion < 5) {
					/*
					 * Notify the user that the source level of their project
					 * does not allow use of the promises.jar
					 */
					MessageDialog
							.openInformation(
				 ...
				 */
				final WorkspaceJob wJob = JSureUtility
						.getJobToAddUpdatePromisesJar(jp, jpName);
				wJob.schedule();
