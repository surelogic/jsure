...
public final class ScanManagerView extends ViewPart implements JSureDataDirHub.ContentsChangeListener,
  ...
  public void createPartControl(Composite parent) {
    final CheckboxTableViewer table = CheckboxTableViewer.newCheckList(parent, SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION
        | SWT.MULTI);
    ...
    refreshAction.setToolTipText(I18N.msg("jsure.scan.view.tooltip.refresh"));
    ...
    setAsCurrentAction.setToolTipText(I18N.msg("jsure.scan.view.tooltip.setCurrent"));
    setAsCurrentAction.setEnabled(false);

    final Action rescanAction = f_mediator.getRescanAction();
    rescanAction.setImageDescriptor(SLImages.getImageDescriptor(CommonImages.IMG_JSURE_RE_VERIFY));
    rescanAction.setText(I18N.msg("jsure.scan.view.text.rescan"));
    rescanAction.setToolTipText(I18N.msg("jsure.scan.view.tooltip.rescan"));
    ...
    deleteScanAction.setToolTipText(I18N.msg("jsure.scan.view.tooltip.delete"));
