...
public class SendLibraryAnnotationHandler extends AbstractHandler {
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    try {
      ...
      SLLogger.getLogger().log(Level.WARNING, "Failure writing textArchive.txt temp file of annotation changes: " + temp, e);
    } finally {
      if (archive != null) {
        archive.close();
      }
    ...
    if (archive != null) {
      if (archive.isEmpty()) {
        MessageDialog.openInformation(EclipseUIUtility.getShell(), "No Library Annotation Changes",
      ...
      SendServiceMessageWizard.openTip(null, SLLicenseProduct.JSURE + " " + EclipseUtility.getSureLogicToolsVersion(),
  ...
  private static class Archiver extends TextArchiver {
    ...
    String getDescription() {
      StringBuilder sb = new StringBuilder("Archive of library annotation changes for the following packages:\n");
