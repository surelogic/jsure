...
public abstract class Filter {
	...
	/**
	 * Counts for just this filter. The key of this map is the definitive list
	 * of values for this filter. Only mutated by
	 * {@link #refreshCountsFor(List)}.
	 */
	...
	public void setPorous(String value, boolean porous) {
		 ...
		 * changed the set of results that I let through.
		 */
	...
	/**
	 * The count of results that this filter, based upon what is set to be
