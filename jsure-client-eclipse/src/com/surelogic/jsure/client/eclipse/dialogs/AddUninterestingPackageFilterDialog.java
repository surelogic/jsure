...
public final class AddUninterestingPackageFilterDialog extends TitleAreaDialog {
	...
	/**
	 * Gets the filter entered by the user into this dialog. The filter should
	 * be a valid Java regular expression and should not be a duplicate of an
	...
	protected Control createDialogArea(Composite parent) {
		...
		variableLabel.setForeground(getShell().getDisplay().getSystemColor(
				SWT.COLOR_BLUE));
		variableLabel.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false));
		f_filterText = new Text(panel, SWT.SINGLE);
		f_filterText.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false));
	...
	private void checkIfFilterisOkay() {
