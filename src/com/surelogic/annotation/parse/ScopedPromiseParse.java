...
//    printAST(initParser("  java*Object  ").wildcardIdentifier().tree, false);
    ...
    System.out.println(initParser("'temp\n'  ").scopedPromise().tree.getText());
    System.out.println(initParser("'a\n'").scopedPromise().tree.getText());
    System.out.println(initParser("''").scopedPromise().tree.getText());
    ...
    printAST(initParser("foo.intValue(int)").methodMatchPattern().tree, false);
    printAST(initParser("foo.intValue()").methodMatchPattern().tree, false);
    printAST(initParser("foo.intValue()").noReturnMethodDeclPattern().tree, false);
    printAST(initParser("foo.intValue(int)").baseTarget().tree, false);
    printAST(initParser("foo.intValue(boolean)").andTarget().tree, false);
    printAST(initParser("foo.intValue(**) & foo.intValue(int)").andTarget().tree, false);
    ...
    printAST(initParser("foo.intValue(**)").promiseTarget().tree);
    printAST(initParser("foo.intValue(**) & foo.intValue(int)").promiseTarget().tree, false);
    printAST(initParser("foo.intValue(**)").promiseTarget().tree, false);
    ...
    printAST(initParser("'reads Instance' for foo.intValue()").scopedPromise().tree);
...
//    printAST(initParser("'reads Instance' for foo.intValue(long)").scopedPromise().tree);
    ...
    */
    ...
    printAST(initParser("'reads Instance' for foo.intValue()").scopedPromise().tree);
    printAST(initParser("'reads Instance' for foo.intValue() & foo.charValue()").scopedPromise().tree);
    printAST(initParser("'reads Instance' for foo.intValue() & foo.charValue() | foo.doubleValue()").scopedPromise().tree);
    //
    printAST(initParser("'reads Instance' for public foo.intValue()").scopedPromise().tree);
    printAST(initParser("'reads Instance' for public foo.intValue(int)").scopedPromise().tree);
    printAST(initParser("'reads Instance' for public foo.intValue(int, boolean)").scopedPromise().tree);
    printAST(initParser("'reads Instance' for public foo.intValue(int, boolean, String)").scopedPromise().tree);
    printAST(initParser("'reads Instance' for protected foo.intValue()").scopedPromise().tree);
    printAST(initParser("'reads Instance' for protected static foo.intValue()").scopedPromise().tree);
    printAST(initParser("'reads Instance' for protected !static foo.intValue()").scopedPromise().tree);
    
    printAST(initParser("'reads Instance' for foo.longValue() throws Exception").scopedPromise().tree);
    printAST(initParser("'reads Instance' for public foo.longValue() throws Exception").scopedPromise().tree);
