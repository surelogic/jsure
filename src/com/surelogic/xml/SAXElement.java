...
public class SAXElement
{
	...
	private HashMap<String, String> attMap = 
		new HashMap<String, String>(TestXMLParserConstants.HASH_MAP_LOAD);
	...
	/**
	 * addToCdata concats onto cdata, because the parser may generate
	 * several events for the same cdata string 
	 */
