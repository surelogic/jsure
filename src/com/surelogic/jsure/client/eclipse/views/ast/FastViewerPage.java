...
public class FastViewerPage extends ContentOutlinePage implements
		IFastViewerPage {
	...
	/**
	 * Subclasses must extend this method configure the tree viewer with a
	...
	private static class ContentProvider extends LabelProvider implements
		...
		private IRNode convert(Object o) {
			try {
				...
				LOG.severe("Trying to cast a " + o.getClass().getName()
						+ " to IRNode");
				return null;
			}
		}
