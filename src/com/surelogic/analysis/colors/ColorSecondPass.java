...
import static com.surelogic.annotation.rules.ColorRules.getMutableRequiresColorSet;
import static com.surelogic.annotation.rules.ColorRules.isColorRelevant;
...
public class ColorSecondPass {
  ...
  private static boolean hasUserWrittenRequireDrops(IRNode node) {
    ...
    return !getMutableRequiresColorSet(node).isEmpty();
  }
  ...
  private ResultDrop makeResultDrop(final IRNode context, final PromiseDrop p,
    ...
    if (isConsistent) {
      result = ColorMessages.createResultDrop(msg, "TODO: fill me in", context);
    } else {
      result = ColorMessages.createProblemDrop(msg, "TODO: Fill Me In", context);
    }
  ...
  static void checkSomeCRMs(List<ColorizedRegionModel> crms, IRNode locInIR,
    ...
    for (ColorizedRegionModel crm : crms) {
      ...
      if (!constraintMet) {
        ...
        msg.append('.');
        ResultDrop rd = ColorMessages.createResultDrop(msg.toString(), "TODO: fill me in", locInIR);
    ...
    private JBDD revokeForInfer(JBDD ctx,
      ...
      while (revIter.hasNext()) {
        ...
        if (checkingErrors) {
          ...
          ResultDrop rd = ColorMessages.createResultDrop(msg.toString(), "TODO: fill me in", node);
    ...
    public void visitCall(ColorStaticCall node) {
      ...
      if (checkingErrors) {
        ...
        if (!contextImpliesReq(mDecl, ctxIsEmpty, currCtx, reqSumm)) {
          ...
          msg.append('.');
          ResultDrop rd = ColorMessages.createResultDrop(msg.toString(), "TODO: fill me in", root);
          rd
              .addSupportingInformation(
