 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class ColorBDDPack {


  static final ColorBDDPack INSTANCE = new ColorBDDPack();
...
//    final ColorNameModel nameModel = ColorNameModel.getInstance(colorName);
...
//  }
   ...
   */
  public static ColorBDDPack getInstance() {
    return INSTANCE;
  }
