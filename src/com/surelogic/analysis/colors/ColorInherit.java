...
final public class ColorInherit {
  ...
  public static final void doInherit(IRNode mth) {
    ...
    final ColorReqSummaryDrop mthReqSumm = ColorRules.getReqSummDrop(mth);
...
//    Collection reqsHere = ColorRules.getReqDrops(mth);
//    Collection ctxHere = ColorRules.getCtxDrops(mth);
    boolean icrHere = ColorRules.isColorRelevant(mth);
    
//    final boolean haveReqsHere = !reqsHere.isEmpty();
//    final boolean haveCtxHere = !ctxHere.isEmpty();
    
    
//    Collection oldInheritedReqDrops = ColorRules.getInheritedRequireDrops(mth);
//    Collection oldInheritedCtxDrops = ColorRules.getInheritedContextDrops(mth);
...
//      Collection reqsFromParent = ColorRules.getReqDrops(mDecl);
//      if (reqsFromParent.isEmpty()) {
//        reqsFromParent = ColorRules.getInheritedRequireDrops(mDecl);
//      }
      
//      Collection ctxFromParent = ColorRules.getCtxDrops(mDecl);
//      if (ctxFromParent.isEmpty()) {
//        ctxFromParent = ColorRules.getInheritedContextDrops(mDecl);
//      }
      
      boolean icrFromParent = ColorRules.isColorRelevant(mDecl);
