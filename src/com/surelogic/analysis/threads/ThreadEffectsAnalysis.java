...
public final class ThreadEffectsAnalysis implements IBinderClient {
	 ...
	 */
	private void examineBlock(IRNode block, Operator blockOp,
	 ...
	 */
	private boolean checkNodeThreadEffects(StartsPromiseDrop pd,
	 ...
	 * @param modelName
	 */
	private void checkCallThreadEffects(StartsPromiseDrop pd,
			final IRNode node, String modelName) {
