...
public class Messages extends AbstractMessages {
  ...
  public static String ThreadEffectsAnalysis_callNotPromiseDrop = "Call \" {0} \" has not promised to start nothing";
  ...
  public static String LockAnalysis_ds_MasqueradingCall = "\"{0}\" does not call a method from java.util.concurrent.Lock";

  public static String LockAnalysis_ds_MasqueradingCall2 = "\"{0}\" does not call a method from java.util.concurrent.ReadWriteLock";
