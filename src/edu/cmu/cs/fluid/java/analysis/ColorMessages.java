...
import edu.cmu.cs.fluid.sea.drops.promises.ColorResultDrop;
import edu.cmu.cs.fluid.sea.drops.promises.ColoredClassDrop;
...
public static final Category multiThreadedInfoCategory = 
  ...
  public static ResultDrop createResultDrop(String msg, IRNode loc) {
    ResultDrop rd = new ColorResultDrop();
    rd.setConsistent();
  ...
  public static IRReferenceDrop createOutputDrop(Category desiredCategory, String msg,
    ...
    if (desiredCategory == assuranceCategory) {
      return createResultDrop(msg, loc);
      ...
      return createProblemDrop(msg, loc);
    } else {
      return null;
    }
