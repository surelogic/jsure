...
public abstract class TreeWalker {
  ...
  public final Object walkTree( final IRNode root ) {
	...
	ArrayInitializer.getInitIterator( root );
      ...
      return this.arrayLength( root, ArrayLength.getObject(root) );
    }
    ...
    // Skipping ByteType, not sure if it is useful
      ...
      final Iterator<IRNode> clauses = 
	CatchClauses.getCatchClauseIterator( root );
    ...
    // Skipping ConstructionObject because it has subclasses
      ...
      //final IRNode qualifier = ConstructorCall.getQualifier( root );
      final IRNode object = ConstructorCall.getObject( root );
      final IRNode args = ConstructorCall.getArgs( root );
      return constructorCall( root, /*qualifier,*/ object, args );
    }
    ...
    */
      ...
      final IRNode elseClause = IfStatement.getElsePart( root );
      final Operator elseOp   = tree.getOperator( elseClause );     
      final IRNode cond = IfStatement.getCond( root );
      final IRNode thenPart = IfStatement.getThenPart( root );
      if (ElseClause.prototype.includes(elseOp)) {
        return this.ifElseStatement( root, cond, thenPart, ElseClause.getElseStmt( elseClause ));
      }
	...
	ImportDeclarations.getImpsIterator( root );
    ...
    */
    ...
    // NotEqExpression instanceof BinopExpression
      ...
      return this.omittedMethodBody( root );
    }
    ...
    // Skipping PackageDeclaration
      ...
      return this.parameterDeclaration( root, id, mods, type );
    }
    ...
    // Skipping StatementExpression
      ...
      final Iterator<IRNode> stmts = 
	    StatementExpressionList.getExprIterator( root );
  ...
  /** Call <tt>walkTree()</tt> on each element of an enumeration.
    ...
    * input enumeration 
    */
  protected Iterator<Object> walkIterator( final Iterator<IRNode> nodes ) {
  ...
  /** List of method call actual arguments
    ...
    */
  public abstract Object arguments( IRNode root, Iterator<IRNode> args );
  ...
  /** An array initializer.
    ...
    */
  public abstract Object arrayInitializer( IRNode root, Iterator<IRNode> elements );
  
  public abstract Object arrayLength( IRNode root, IRNode array );
  ...
  /** A block of statements.
    ...
    */
  public abstract Object blockStatement( IRNode root, Iterator<IRNode> stmts );
  ...
  /** The list of catch clauses of a try statement
    ...
    */
  public abstract Object catchClauses( IRNode root, Iterator<IRNode> clauses );
  ...
  /** Body of class declaration
    ...
    * declarations
    */
  public abstract Object classBody( IRNode root, Iterator<IRNode> decls );
  ...
  /** Constructor call.
    ...
    */
  public abstract Object constructorCall( IRNode root, /* IRNode qualifier,*/ IRNode object,
					  IRNode args );
  ...
  /** ? */
  public abstract Object dimExprs( IRNode root, Iterator<IRNode> dims );
  ...
  /** List of classes/interfaces being extended.
    ...
    */
  public abstract Object extensions( IRNode root, Iterator<IRNode> classes );
  ...
  /** List of interfaces
    ...
    */
  public abstract Object implementsList( IRNode root, Iterator<IRNode> interfaces );
  ...
  /** Node for a non-existent qualifier
   * @param root Node of expression
   */
  public Object noQualifier( IRNode root ) { return null; }
   ...
   * @param root Node of the body
   */
 public abstract Object omittedMethodBody( IRNode root );
  ...
  /** Formal parameter declaration
    ...
    */
  public abstract Object parameterDeclaration( IRNode root,
					       Object id, int mods,
					       IRNode type );
  ...
  /** List of formal paramers to a constructor or method call
    ...
    */
  public abstract Object parameters( IRNode root, Iterator<IRNode> params );
   ...
   * @return
   */
  public Object qualifier( IRNode root, IRNode expr ) { return null; }
  ...
  /** Comma seperated list of expressions.
    ...
    */
  public abstract Object statementExpressionList( IRNode root, Iterator<IRNode> stmts );
  ...
  /** List of "case" statements.
    ...
    */
  public abstract Object switchBlock( IRNode root, Iterator<IRNode> elements );
  ...
  /** Statements following a "case" of "default" label
    ...
    */
  public abstract Object switchStatements( IRNode root, Iterator<IRNode> stmts );
  ...
  /** List of thrown exceptions
    ...
    */
  public abstract Object throwsList( IRNode root, Iterator<IRNode> types );
  ...
  public abstract Object typeDeclarations( IRNode root, Iterator<IRNode> types );
  ...
  /** List of variables in a declaration.
    ...
    */
  public abstract Object variableDeclarators( IRNode root, Iterator<IRNode> vars );
