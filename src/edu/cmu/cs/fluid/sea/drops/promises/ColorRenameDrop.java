...
import edu.cmu.cs.fluid.java.analysis.CLeafExpr;
 ...
 */
@Deprecated
public class ColorRenameDrop extends PromiseDrop {
  ...
  private ColorRenameDrop(final String name, final CExpr expr, IRNode where) {
    rawExpr = expr;
  ...
  public static ColorRenameDrop buildColorRenameDrop(final String name,
      final CExpr expr, IRNode where) {
    ColorRenameDrop res = new ColorRenameDrop(name, expr, where);
