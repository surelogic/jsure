 ...
 */
public class ColorDeclareDrop extends ColorNameListDrop<ColorDeclarationNode> {
...
//    new HashMap<String, ColorDeclareDrop>();
  ...
  public ColorDeclareDrop(ColorDeclarationNode cdn) {
    ...
    String stringCuName = "";
    nameLoop: for (String colorName : getListedColors()) {
