/* $Header: /cvs/fluid/fluid/src/edu/cmu/cs/fluid/template/Field.java,v 1.14 2005/05/25 20:12:15 chance Exp $ */
...
implements Cloneable
{
   ...
   * @param newValue the new value of property "value".
   */
   ...
   * @param newValue the new value of property "empty".
   */
