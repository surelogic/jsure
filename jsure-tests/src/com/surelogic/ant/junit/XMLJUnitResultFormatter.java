...
public class XMLJUnitResultFormatter implements JUnitResultFormatter, XMLConstants {
    ...
    public void endTest(Test test) {
      if (test instanceof SLTest) {
        ...
        endTest(test, test.getClass().getCanonicalName(),
                      JUnitVersionHelper.getTestCaseName(test));
      }
    }
    
    public void endTest(SLTest test) {
      endTest(test, test.getClassName(), test.getTestName());
    }
    
    private void endTest(Test test, String className, String testName) {
