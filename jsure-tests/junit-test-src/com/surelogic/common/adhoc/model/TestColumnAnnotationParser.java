...
public class TestColumnAnnotationParser extends TestCase {
  ...
  public void testSum() {
    ...
    assertFalse(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getAggregateSuffix());
  ...
  public void testCountNonempty() {
    c = ColumnAnnotationParserUtility.parse("(count nonempty)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    assertTrue(c.countNonempty());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty prefix 'v=')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("v=", c.getAggregatePrefix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count nonempty)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals("p", c.getAggregatePrefix());
    assertEquals("s", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count nonempty prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count nonempty prefix '' suffix '')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals("", c.getAggregatePrefix());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty on 1 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
    ...
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty on 1,2,3,4,5 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertFalse(c.countDistinct());
  ...
  public void testCountDistinctNonempty() {
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty prefix 'v=')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("v=", c.getAggregatePrefix());
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count distinct nonempty)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals("p", c.getAggregatePrefix());
    assertEquals("s", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count distinct nonempty prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(count distinct nonempty prefix '' suffix '')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals("", c.getAggregatePrefix());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty on 1 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
    ...
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count distinct nonempty on 1,2,3,4,5 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertNull(c.getCountReplaceValueWith());
    assertTrue(c.countDistinct());
  ...
  public void testCountReplaceValuesWithOneNonempty() {
    c = ColumnAnnotationParserUtility.parse("(count nonempty replace-value-with 'one')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertEquals(c.getCountReplaceValueWith(), "one");
    assertTrue(c.countNonempty());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty replace-value-with 'one' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertEquals(c.getCountReplaceValueWith(), "one");
    assertTrue(c.countNonempty());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty replace-value-with 'one' on 1 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertEquals(c.getCountReplaceValueWith(), "one");
    assertTrue(c.countNonempty());
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(count nonempty replace-value-with 'one' on 1,2,3,4,5 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertEquals(c.getCountReplaceValueWith(), "one");
    assertTrue(c.countNonempty());
  ...
  public void testContains() {
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    assertFalse(c.countNonempty());
    assertEquals("x", c.getContainsValue());
    assertEquals("y", c.getShowValue());
    assertNull(c.getCountReplaceValueWith());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y' prefix 'v=')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("v=", c.getAggregatePrefix());
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y' prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(contains 'x' show 'y')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals("p", c.getAggregatePrefix());
    assertEquals("s", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(contains 'x' show 'y' prefix 'v=' suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals("v=", c.getAggregatePrefix());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(prefix 'p')(suffix 's')(contains 'x' show 'y' prefix '' suffix '')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals("", c.getAggregatePrefix());
    assertEquals("", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y' on 1 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
    ...
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getAggregateSuffix());
    c = ColumnAnnotationParserUtility.parse("(contains 'x' show 'y' on 1,2,3,4,5 suffix ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.containsPartialRows());
    assertFalse(c.countPartialRows());
    assertFalse(c.countDistinct());
