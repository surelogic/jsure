...
public class TestColumnAnnotationParser extends TestCase {
  ...
  public void testCount() {
    ...
    assertFalse(c.countReplaceValuesWithOne());
    assertFalse(c.countDistinct());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getSuffix());
  ...
  public void testCountReplaceValuesWithOne() {
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertFalse(c.countDistinct());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getSuffix());
    ...
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getSuffix());
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one on 1,2,3,4,5 ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertFalse(c.countDistinct());
  ...
  public void testCountReplaceValuesWithOneDistinct() {
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one distinct)");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertTrue(c.countDistinct());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals("", c.getSuffix());
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one distinct ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertTrue(c.countDistinct());
    assertEquals(Collections.emptySet(), c.getOnSet());
    assertEquals(" ms", c.getSuffix());
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one distinct on 1 ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertTrue(c.countDistinct());
    assertEquals(one, c.getOnSet());
    assertEquals(" ms", c.getSuffix());
    c = ColumnAnnotationParserUtility.parse("(count-replace-values-with-one distinct on 1,2,3,4,5 ' ms')");
    assertTrue(c.isValid());
    assertTrue(c.countPartialRows());
    assertTrue(c.countReplaceValuesWithOne());
    assertTrue(c.countDistinct());
