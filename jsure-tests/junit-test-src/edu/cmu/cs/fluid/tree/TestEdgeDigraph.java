/* $Header: /cvs/fluid/fluid/src/edu/cmu/cs/fluid/tree/TestEdgeDigraph.java,v 1.15 2009/02/27 19:01:20 chance Exp $ */
package edu.cmu.cs.fluid.tree;

import edu.cmu.cs.fluid.ir.*;
import edu.cmu.cs.fluid.test.IReporter;

public class TestEdgeDigraph {
  ...
  public TestEdgeDigraph(IReporter r) {
    reporter = r;
  }
  ...
  protected class AsDigraph extends TestDigraph {
    ...
    protected MutableDigraphInterface createCopy(Digraph d) {
  ...
  public void test(String[] args) {
    ...
    test("mutableED",SimpleSlotFactory.prototype);
    test("immutableED",ConstantSlotFactory.prototype,false);
  }
  ...
  public void test(String name, SlotFactory sf) {
    test(name,sf,true);
  }
  
  public void test(String name, SlotFactory sf, boolean mutable) {
    EdgeDigraph edg = createStored(sf);
    EdgeDigraph edg_copy = createCopy(edg);
    test(name,edg,edg_copy,mutable,getDagOK());
  }
  ...
  public void reportError(String test, String message) {
