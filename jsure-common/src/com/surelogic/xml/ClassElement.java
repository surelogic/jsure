...
public class ClassElement extends AnnotatedJavaElement {
  private final Map<String, NestedClassElement> classes = new HashMap<>(0);
  private final Map<String, FieldElement> fields = new HashMap<>(0);
  private final HashMap<Pair<String, String>, MethodElement> methods = new HashMap<>();
  private final Map<String, ConstructorElement> constructors = new HashMap<>(0);
  ...
  public Collection<MethodElement> getMethods() {
    final List<MethodElement> elements = new ArrayList<>(methods.values());
  ...
  public boolean hasChildren() {
    return !methods.isEmpty() || !constructors.isEmpty() || super.hasChildren() || !classes.isEmpty() || !fields.isEmpty()
        || clinit != null;
  }
  ...
  public MergeResult<ClassElement> merge(ClassElement changed, MergeType type) {
    if (getName().equals(changed.getName())) {
      ...
      return new MergeResult<>(this, modified);
    }
