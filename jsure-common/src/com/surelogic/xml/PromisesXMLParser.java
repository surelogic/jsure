...
public final class PromisesXMLParser {
   ...
   * 
   * @throws Exception
   *           if the release library annotation XML directory cannot be found
  ...
  public static File getFluidXMLDir() {
    ...
    final File fLibDir = new File(fluidDir, TestXMLParserConstants.PROMISES_XML_REL_PATH);
  ...
  public static File getLocalXMLDirOrNull() {
    final String XmlDiffPath = IDERoot.getInstance().getStringPreference(IDEPreferences.JSURE_XML_DIFF_DIRECTORY);
    if (XmlDiffPath != null) {
