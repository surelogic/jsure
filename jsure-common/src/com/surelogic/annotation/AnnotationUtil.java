...
public final class AnnotationUtil {
  ...
  private static final String[] noArgMethods = new String[] { "toString", "hashCode", "annotationType", };

  private static final ConcurrentMap<String, Map<String, Attribute>> attrsByPromise = new ConcurrentHashMap<>();
  ...
  private static Map<String, Attribute> computeAttributes(String tag) {
    ...
    try {
      ...
      Map<String, Attribute> l = new HashMap<>();
      ...
      outer: for (Method m : cls.getMethods()) {
        ...
        /*
         * if (AnnotationConstants.VALUE_ATTR.equals(m.getName())) { continue
         * outer; }
         */
        ...
        l.put(m.getName(), new Attribute(m.getName(), type, value == null ? null : value.toString()));
      }
