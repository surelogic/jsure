...
/**
 * The result of refactoring out the commonality in
 * Customizable{Hashed,HashCode}Map
 * 
 * @author chance
 */
public abstract class AbstractHashMap<K, V> implements Map<K, V> {
   ...
   * This implementation uses the equals method. Subclasses can override this to
   * match differently.
   *
   * @param key1
