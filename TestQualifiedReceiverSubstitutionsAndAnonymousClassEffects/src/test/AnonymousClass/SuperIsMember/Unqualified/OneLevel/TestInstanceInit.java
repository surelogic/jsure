...
public class TestInstanceInit {
  ...
  public class Middle1 {
    ...
    public class Middle2 {
      ...
      @RegionEffects("writes TestInstanceInit.this:t1, TestInstanceInit.this:t2, test.AnonymousClass.SuperIsMember.Unqualified.OneLevel.TestInstanceInit.Middle1.this:m1")
      public Middle2() {
