    ...
    class OuterLocal1 {
      ...
      public void middleMethod() {
        class OuterLocal2 {
          ...
          @RegionEffects("writes r1, r2, any(OuterLocal1):s1, any(OuterLocal1):s2, any(Outer):t1, any(Outer):t2")
          public void outerMethod() {
            class Super {
              ...
              @RegionEffects("writes OuterLocal2.this:r1, OuterLocal2.this:r2, any(OuterLocal1):s1, any(OuterLocal1):s2, any(Outer):t1, any(Outer):t2")
              public Super doStuff() {
                 ...
                 * 
                 * Writes any(Outer).t1, any(Outer).t2, OuterLocal2.this.r1, OuterLocal2.this.r2, any(OuterLocal1).s1, any(OuterLocal1).s2
                 */
                return new Super() {
                  private int g = 10;
                  { t2 += 1; }
             ...
             * 
             * Writes this.r1, this.r2, any(OuterLocal1).s1, any(OuterLocal1).s2, any(Outer).t1, any(Outer).t2
             */
            ...
            class Middle1 {
              ...
              @RegionEffects("writes this:m1, OuterLocal2.this:r1, OuterLocal2.this:r2, any(OuterLocal1):s1, any(OuterLocal1):s2, any(Outer):t1, any(Outer):t2")
              public Super doStuff() {
              ...
              class Middle2 {
                ...
                @RegionEffects("writes this:m2, any(Middle1):m1, OuterLocal2.this:r1, OuterLocal2.this:r2, any(OuterLocal1):s1, any(OuterLocal1):s2, any(Outer):t1, any(Outer):t2")
                public Super doStuff() {
                   ...
                   * The immediately enclosing instance with respect to Super is OuterLocal2.this
                   * 
                   * Writes this.m2, any(Middle1).m1, OuterLocal2.this.r1, OuterLocal2.this.r2, any(OuterLocal1).s1, any(OuterLocal1).s2, any(Outer).t1, any(Outer).t2
                   */
                  return new Super() {
                    private int g = 10;
                    { m1 += 1; }
