...
public interface IAnnotationParseRule<A extends IAASTRootNode, D extends PromiseDrop<? super A>>
  ...
  /**
   * Returns the name of the annotation being unparsed. Assumed to be a constant
   * String
   */
  String name();
  ...
  /**
   * Create one or more AASTs on the AST node from the provided text. All drops
   * and/or errors are reported via the context.
   * 
   * @param n
   *          The AST node to be associated with the drops
   * @param contents
   *          The text to parse
   */
