...
public abstract class AnnotationRules {
  ...
  private IAnnotationScrubberContext context = new IAnnotationScrubberContext() {
    ...
    public ModelingProblemDrop reportError(IAASTNode n, int number, Object... args) {
      ...
      final ModelingProblemDrop d = makeProblemDrop(n.getAnnoContext() != null ? n.getAnnoContext() : n.getPromisedFor(),
          n.getOffset());
    ...
    @Override
    public IModelingProblemDrop reportError(final IAASTNode n, final String msgTemplate, final Object... args) {
    ...
    @Override
    public ModelingProblemDrop reportErrorAndProposal(ProposedPromiseDrop p, String msgTemplate, Object... args) {
      ModelingProblemDrop d = reportError_private(p.getNode(), msgTemplate, args);
      d.addProposal(p);
      return d;
    }

    private ModelingProblemDrop reportError_private(IRNode n, String msgTemplate, Object... args) {
    ...
    @Override
    public IModelingProblemDrop reportWarningAndProposal(ProposedPromiseDrop p, String msgTemplate, Object... args) {
    ...
    private ModelingProblemDrop markAsWarning(final ModelingProblemDrop d) {
      if (d != null) {
        final IKeyValue diffInfo = KeyValueUtility.getEnumInstance(IModelingProblemDrop.SEVERITY_HINT,
   ...
   */
  // protected static <A extends IAASTRootNode, P extends PromiseDrop<? super
  // A>> P ensureDropForAST(
