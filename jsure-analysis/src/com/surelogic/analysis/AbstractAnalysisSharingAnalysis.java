...
public abstract class AbstractAnalysisSharingAnalysis<S, T extends IBinderClient, Q extends IAnalysisGranule>
    extends AbstractWholeIRAnalysis<T, Q> {
  protected final SharedAnalysisFactory<S> factory;
  private S sharedAnalysis;

  protected AbstractAnalysisSharingAnalysis(boolean inParallel, String logName, SharedAnalysisFactory<S> f) {
    super(inParallel, logName);
    factory = f;
  }
