...
public final class IntrinsicLockAnalysis extends
  ...
  @Override
  protected JavaForwardAnalysis<Object[], IntrinsicLockLattice>
  createAnalysis(final IRNode flowUnit) {
    final IntrinsicLockLattice intrinsicLockLattice =
      IntrinsicLockLattice.createForFlowUnit(flowUnit, lockExprManager);    
    ...
    protected Object[] transferIsObject(IRNode node, boolean flag, Object[] value) {
      if (!flag) {
        ...
        if (FieldRef.prototype.includes(operator)) {
          ...
          if (isLockGetterMethod(node) ||
              lockUtils.isMethodFromJavaUtilConcurrentLocksReadWriteLock(node)) {
