...
public class UniquenessAnalysisModule extends AbstractWholeIRAnalysis<UniquenessAnalysis,CUDrop> {
...
//    return new UniquenessAnalysis(binder, false);
    ...
    try {
      ...
      if (duration > tooLongDuration) {
        ...
        final HintDrop info = HintDrop.newWarning(node.getMethod());
