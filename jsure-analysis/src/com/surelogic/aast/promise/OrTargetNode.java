...
public class OrTargetNode extends ComplexTargetNode { 
  ...
  public static final AbstractAASTNodeFactory factory =
    new AbstractAASTNodeFactory("OrTarget") {
      ...
      public AASTNode create(String _token, int _start, int _stop,
        ...
        return new OrTargetNode (_start,
          target1,
          target2        );
      }
    };
   ...
   */
  public OrTargetNode(int offset,
  ...
  protected IAASTNode internalClone(final INodeModifier mod) {
  	return new OrTargetNode(getOffset(), (PromiseTargetNode)getTarget1().cloneOrModifyTree(mod), (PromiseTargetNode)getTarget2().cloneOrModifyTree(mod));
  }
}
