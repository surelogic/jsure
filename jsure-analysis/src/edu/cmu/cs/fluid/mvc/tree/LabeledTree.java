 ...
 * to the nodes and that only supports a single root.
 *
...
extends ForestModel
{
   ...
   */
  public static final String LABEL = "LabeledTree.label";
  ...
  {
    public LabeledTree create( String name, SlotFactory sf )
