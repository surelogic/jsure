...
public interface BackwardTransfer<T> {
   ...
   * @param node syntax node associated with this component
   * @param info information in the component sink node.
   ...
   * to analyze.
   */
  public T transferComponentFlow(IRNode node,
                       Object info,
                       T after);
   ...
   */
  public T transferComponentChoice(IRNode node,
                     Object info,
                     boolean flag,
                     T after);
