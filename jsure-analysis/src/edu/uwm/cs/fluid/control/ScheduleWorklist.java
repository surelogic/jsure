...
/**
 * Worklist that uses a fixed schedule (same as that used by priority queue
 * worklist). Loops are iterated as long as there are any changes in the loops.
 * Avoids the memory and time overhead in managing a priority queue, while
 * sometimes evaluating loops a bit more than necessary.
 * 
 * @author boyland
 */
